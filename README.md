[![Build status](https://dev.azure.com/umutesen/onthecode/_apis/build/status/Material%20Template%20CI)](https://dev.azure.com/umutesen/onthecode/_build/latest?definitionId=11)
 ...
 # Angular 22 Material Starter Template

 ![Product Gif](https://github.com/umutesen/angular-material-template/blob/media/material-template-demo.gif)


Angular 22 Material Starter Template is a free template built with Angular  and Angular Material. You can use it out of the box without having to change any file paths. Everything you need to start development on an Angular project is here.

Angular 22 Material Starter Template has been built with the official style guide in mind, which means it promotes a clean folder structure and separation of concerns. The material template is fully responsive and contains the fundamental building blocks of a scalable Angular application:
...
This application template is based off [umutesen angular-material-template](https://github.com/umutesen/angular-material-template) but has been updated to Angular 22 and has a few other changes like light/dark mode switching.
